...
class Status {
    ...
    public function addStatus($engineStatus, $filtrationStatus, $phLevel, $reason, $date) {
        $sql = "INSERT INTO statuses (engine_status, filtration_status, ph_level, reason, date) VALUES ('$engineStatus', '$filtrationStatus', '$phLevel', '$reason', '$date')";
...
if (isset($_POST['submit'])) {
    ...
    if ($status->addStatus($newEngineStatus, $newFiltrationStatus, $newPHLevel, $reason, $date)) {
